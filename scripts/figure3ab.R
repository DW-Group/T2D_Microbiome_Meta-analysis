...
pwy_2 <- ggplot(pwy_2_data, aes(x=study, y=pathway)) +
  ...
  scale_fill_gradientn(
    ...
    breaks=c(-0.5,0,1.0),
    limits=c(-0.5,1.0)) +
  geom_text(aes(label=star1), color="black", size=7, nudge_y = 0.05) +
  geom_text(aes(label=star2), color="black", size=7, nudge_y = 0.0) +
  geom_text(aes(label=star3), color="black", size=9, nudge_y = -0.2) +
...
pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/R1/fig3/figure3ab.pdf", 
...
pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/R1/fig3/figure3ab_legend_spe.pdf", 
    width = 5, height = 8, onefile = F) # Open a new pdf file
grid::grid.draw(ggpubr::get_legend(legend_spe))
dev.off() # Close the file

ecs_1_data[20:22, "group"] <- c("Saturated fatty acid biosynthesis", "Sulfur-containing amino acid biosynthesis",
...
pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/R1/fig3/figure3ab_legend_grp.pdf", 
