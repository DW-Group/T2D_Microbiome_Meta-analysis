...
(p_tree <- ggtree(treefile2,
    ...
    xlim(-15,NA)+
    geom_hilight(node=1891,type = "gradient",
                 extendto=44, alpha=0.15, fill=col_sec[1], color="grey40",
                 size=0.15)+
    geom_hilight(node=1897,type = "gradient",
                 extendto=44, alpha=0.15, fill=col_sec[12], color="grey40",
                 size=0.15)+
    geom_hilight(node=1877,type = "gradient",
                 extendto=44, alpha=0.15, fill=col_sec[3], color="grey40",
                 size=0.15)+
    geom_hilight(node=1896,type = "gradient",
                 extendto=44, alpha=0.15, fill=col_sec[5], color="grey40",
                 size=0.15)+
    geom_tippoint(mapping = aes(color=T2D),
                  size=0.4,
                  show.legend = F)+
