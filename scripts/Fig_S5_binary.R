...
pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/R1/figS5/figure_s5b.pdf",
    width = 8, height = 34, onefile = F) # Open a new pdf file
egg::ggarrange(heat1, heat1_0, heat2, heat2_0, nrow=2, ncol=2,
               widths = c(1, 0.1), heights=c(50,47))
...
#   annotate(geom="text", x=-1.0, y=1.3, col="black", label="r=0.97", size=4.2)
# 
...
#         axis.title = element_text(colour = "black", size=12),
#         panel.border = element_rect(colour = "black", size=1.2)) +
#   annotate(geom="text", x=-0.7, y=1.1, col="black", label="r=0.87", size=4.2)
# 
# pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/dropbox/fig_s4/figure_s4bc_binary.pdf",
#     width = 6, height = 3, onefile = F) # Open a new pdf file
# egg::ggarrange(p1, p3, nrow=1, ncol=2)
# dev.off() # Close the file
# 
# save.image(file="/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/dropbox/fig_s4/figure_s4_binary.RData")
# 
