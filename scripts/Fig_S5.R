setwd("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/dropbox/fig_s4/")

library(tidyverse)
load("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/0323/species_trend.RData")
gdata::keep(meta_0, meta_1, meta_3, meta_4, taxa, sure=T)
...
# -0.660285 -0.163425 -0.007528  0.025415  0.205575  0.717679 
...
cor(beta)
#           mod0      mod1      mod3      mod4
# mod0 1.0000000 0.9760012 0.8793888 0.8699667
# mod1 0.9760012 1.0000000 0.9071312 0.8939283
# mod3 0.8793888 0.9071312 1.0000000 0.9921755
# mod4 0.8699667 0.8939283 0.9921755 1.0000000
...
pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/dropbox/fig_s4/figure_s4a.pdf",
    width = 7.7, height = 36.5, onefile = F) # Open a new pdf file
egg::ggarrange(heat1, heat1_0, heat2, heat2_0, nrow=2, ncol=2,
               widths = c(1, 0.1), heights=c(51,56))
