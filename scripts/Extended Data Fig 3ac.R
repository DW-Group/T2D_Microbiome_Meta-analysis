...
pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/R2/figS5/fig_s5a.pdf",
    width = 7.8, height = 25, onefile = F) # Open a new pdf file
egg::ggarrange(heat1, heat1_0, heat2, heat2_0, nrow=2, ncol=2,
               widths = c(1, 0.1), heights=c(26,42))
...
pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/R2/figS5/fig_s5a_legend.pdf",
...
p1 <- ggplot(aes(x=mod0, y=mod1), data=beta) +
  ...
  annotate(geom="text", x=-0.45, y=0.63, col="black", label="r=0.97", size=4.2)
...
pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/R2/figS5/fig_s5c.pdf",
    width = 6, height = 3, onefile = F) # Open a new pdf file
