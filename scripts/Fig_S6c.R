load(file="/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/0323/metf_species/species_nometf_noinsul_ordinal.RData")

library(ggplot2)
dataplot <- data.frame(all=meta_3v2$coef, 
                       nometf=meta_nometf_results$coef)
cor(dataplot$all, dataplot$nometf) # 0.95

pdf("/n/holylabs/LABS/dwang_lab/Lab/T2D_meta/3.analysis/dropbox/fig_s6/figure_s6d_ordinal.pdf", 
